            ...
            >
              ...
              <div className="space-y-4 text-gray-600 text-lg leading-relaxed">
                <p>
                  ...
                  nació en octubre de 2023 con el propósito de mejorar la
                  calidad de vida de los gatos callejeros en Jódar. Esta
                  iniciativa fue impulsada por dos jóvenes comprometidas con la
                  protección animal, quienes, al observar la difícil situación
                  de las colonias felinas en el municipio, decidieron actuar.
                </p>
                <p>
                  Desde sus inicios, la asociación ha crecido gracias al apoyo
                  de voluntarios locales, consolidándose como un proyecto
                  comunitario basado en la solidaridad y el respeto por los
                  animales. Nuestro trabajo se centra en la gestión ética de las
                  colonias felinas mediante la aplicación del método CER
                  (Captura, Esterilización y Retorno), el rescate de gatos en
                  situación de riesgo y la búsqueda de hogares responsables para
                  aquellos que no pueden regresar a la calle.
                </p>
              </div>
